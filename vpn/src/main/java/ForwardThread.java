...
public class ForwardThread extends Thread {
    ...
    //private int cryptDet;
    private boolean cryptDet;
     ...
     */
    ForwardThread(ForwardServerClientThread aParent, InputStream aInputStream, OutputStream aOutputStream, boolean crypt) throws NoSuchPaddingException, NoSuchAlgorithmException {
